if (!customElements.get('variant-selects')) {
  ...
  class VariantSelects extends HTMLElement {
    ...
    onVariantChange(event) {
      ...
      // Update variant input and trigger change event
      const variantInput = document.querySelector(`#product-form-${this.dataset.section} input[name="id"]`);
      if (variantInput) {
      ...
      this.toggleAddButton(!variant.available, window.theme.variantStrings.soldOut);
    ...
    updateMedia(variant) {
      ...
      let mediaId = `#Slide-${this.dataset.section}-${variant.featured_media.id}`;
      let activeMedia = this.productSlider.querySelector(mediaId);

      if (this.thumbnails) {
        this.setActiveMediaSlider(mediaId, `#Thumb-${this.dataset.section}-${variant.featured_media.id}`, this.productSlider);
      } else {
